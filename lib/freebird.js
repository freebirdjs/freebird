...
function Freebird(netcores, options) {
    ...
    var self = this,
        ...
        defaultDbFolder = path.resolve(__dirname, '../database'),
    ...
    var maxDevNum = options.maxDevNum || 200,
        ...
        devDbPath = (_.isObject(options.dbPaths) ? options.dbPaths.device : undefined),
        gadDbPath = (_.isObject(options.dbPaths) ? options.dbPaths.gadget : undefined) || gadboxPath;

    if (devDbPath)
        defaultDbFolder = undefined;
    else
        devDbPath = devboxPath;
