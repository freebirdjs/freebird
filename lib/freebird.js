...
Freebird.prototype.findWsApi = function (subsys, cmdName) {
    var wsApi;

    if (this._wsApis[subsys])
        wsApi = this._wsApis[subsys][cmdName];
