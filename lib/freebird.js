...
/***********************************************************************/
Freebird.prototype.enable = syncPattern('enable');
Freebird.prototype.enable = syncPattern('disable');

Freebird.prototype.start = asyncPattern1('start');
Freebird.prototype.stop = asyncPattern1('stop');
Freebird.prototype.reset = asyncPattern1('reset');
Freebird.prototype.permitJoin = asyncPattern1('permitJoin');

Freebird.prototype.remove = asyncPattern2('remove');
Freebird.prototype.ban = asyncPattern2('ban');
Freebird.prototype.unban = asyncPattern2('unban');
Freebird.prototype.ping = asyncPattern2('ping');
...
/***********************************************************************/
function syncPattern(method, args) {
...
function asyncPattern1(method, args) {
    var netcores = this._netcores,
        numOfNcs = netcores.length,
        method = nc[method],
        cbCalled = false;
...
function asyncPattern2(method) {
    return function (ncName, permAddr, callback) {
        ...
        netcore[method](permAddr, callback);
    }
}
...
// Freebird.prototype.disable = function (callback) {
//     var netcores = this._netcores,
//         numOfNcs = netcores.length,
//         cbCalled = false;
