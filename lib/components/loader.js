...
loader.reloadSingleDev = function (freebird, devRec, callback) {
    ...
    recoveredDev._recoverFromRecord(devRec);    // [TODO] id = null will throw, should be a string or a number
...
loader.reloadSingleGad = function (freebird, gadRec, callback) {
    ...
    recoveredGad = new Gadget(itsDev, gadRec.auxId);
...
loader.unloadByNetcore = function (freebird, ncName, callback) {
    ...
    if (validate.callback(callback) && !nc) // [TODO] where is validate
