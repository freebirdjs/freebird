...
module.exports = function attachEventListeners(freebird) {
    ...
    freebird.on(LLEVT.NETCORE.ready, ncLsns.ncReady);                           // { netcore }
    freebird.on(LLEVT.NETCORE.error, ncLsns.ncError);                           // { netcore, error: err }
    freebird.on(LLEVT.NETCORE.permitJoin, ncLsns.ncPermitJoin);                 // { netcore, timeLeft: self._joinTicks }
    ...
    freebird.on(LLEVT.NETCORE.devNetChanging, ncLsns.ncDevNetChanging);         // { netcore, permAddr: permAddr, data: changes }
    freebird.on(LLEVT.NETCORE.devIncoming, ncLsns.ncDevIncoming);               // { netcore, permAddr: permAddr, raw: rawDev }
    freebird.on(LLEVT.NETCORE.bannedDevIncoming, ncLsns.ncBannedDevIncoming);   // { netcore, permAddr: permAddr, raw: rawDev }
    freebird.on(LLEVT.NETCORE.devLeaving, ncLsns.ncDevLeaving);                 // { netcore, permAddr: permAddr }
    freebird.on(LLEVT.NETCORE.gadIncoming, ncLsns.ncGadIncoming);               // { netcore, permAddr: permAddr, auxId: auxId, raw: rawGad }
    freebird.on(LLEVT.NETCORE.gadLeaving, ncLsns.ncGadLeaving);                 // { netcore, gad: gad }, internal event, not pass from low-level
    freebird.on(LLEVT.NETCORE.bannedGadIncoming, ncLsns.ncBannedGadIncoming);   // { netcore, permAddr: permAddr, auxId: auxId, raw: rawGad }
    freebird.on(LLEVT.NETCORE.devReporting, ncLsns.ncDevReporting);             // { netcore, permAddr: permAddr, data: devAttrs }
    freebird.on(LLEVT.NETCORE.bannedDevReporting, ncLsns.ncBannedDevReporting); // { netcore, permAddr: permAddr, data: devAttrs }
