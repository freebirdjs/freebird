...
// [TODO]
Freebird.prototype.unregister_plugin = function (freebird, plugin, callback), {
...
// [TODO]
Freebird.prototype.unregister_netcore = function (freebird, nc, callback) {
    var self = this,
        err,
        ncName;
...
Freebird.prototype.register_device = function (freebird, dev, callback) {
    var devId,
        oldDev;
...
Freebird.prototype.unregister_device = function (freebird, dev, callback) {
...
Freebird.prototype.register_gadget = function (freebird, gad, callback) {
    var self = this,
        gadId,
        oldGad;
...
Freebird.prototype.unregister_gadget = function (freebird, gad, callback) {
...
Freebird.prototype._ncInstance = function (freebird, nc) {
    var netcore;
...
Freebird.prototype._devInstance = function (freebird, dev) {
    var device;
...
Freebird.prototype._gadInstance = function (freebird, gad) {
    var gadget;
...
Freebird.prototype._getHttpServer = function (freebird) {
