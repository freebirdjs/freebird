...
describe('APIs - signature checks', function() {
    ...
    describe('NetCore', function() {
        describe('#.getAllDevIds(args, callback)', function() {
        ...
        describe('#.getAllGadIds(args, callback)', function() {
            it('should has error if args.ncName is not a string', function (done) {
                var errMsg = 'ncName should be a string',
                    cb = getCheckedCb(6, errMsg, done);
        ...
        describe('#.getDevs(args, callback)', function() {
        ...
        describe('#.getGads(args, callback)', function() {
            it('should has error if args.ids is not an array of number or string', function (done) {
                var errMsg = 'ids should be an array of number or string',
                    cb = getCheckedCb(7, errMsg, done);
        ...
        describe('#.getNetcores(args, callback)', function() {
            it('should has error if args.ncName is not a string', function (done) {
                var errMsg = 'ncName should be a string',
                    cb = getCheckedCb(6, errMsg, done);
        ...
        describe('#.getBlacklist(args, callback)', function() {
            it('should has error if args.ncName is not a string', function (done) {
                var errMsg = 'ncName should be a string',
        ...
        describe('#.permitJoin(args, callback)', function() {
            it('should has error if args.ncName is not a string', function (done) {
                var errMsg = 'ncName should be a string',
                    cb = getCheckedCb(6, errMsg, done);
        ...
        describe('#.reset(args, callback)', function() {
            it('should has error if args.ncName is not a string', function (done) {
                var errMsg = 'ncName should be a string',
                    cb = getCheckedCb(6, errMsg, done);
        ...
        describe('#.ban(args, callback)', function() {
            it('should has error if args.ncName is not a string', function (done) {
                var errMsg = 'ncName should be a string',
                    cb = getCheckedCb(8, errMsg, done);
        ...
        describe('#.unban(args, callback)', function() {
            it('should has error if args.ncName is not a string', function (done) {
                var errMsg = 'ncName should be a string',
                    cb = getCheckedCb(8, errMsg, done);
        ...
        describe('#.maintain(args, callback)', function() {
            it('should has error if args.ncName is not a string', function (done) {
                var errMsg = 'ncName should be a string',
                    cb = getCheckedCb(6, errMsg, done);
...
describe('APIs - methods checks', function() {
    ...
    describe('Device', function() {
        ...
        describe('#.devDisable', function() {
            ...
            it('if args.id === 2, throw Error', function (done) {
                var devDisableStub = sinon.stub(zDev2, 'disable', function () {
                    throw new Error('catchError');
                });
        ...
        describe('#.devRead', function() {
            ...
            it('if args.id === 2, error', function (done) {
                var devReadStub = sinon.stub(zDev2, 'read', function (attrName, callback) {
                    process.nextTick(function () {
        ...
        describe('#.devWrite', function() {
            it('if args.id === 0, no_such_device', function (done) {
                rpcApis.devWrite({ id: 0, attrName: 'manufacturer', value: 'abcdef' }, function (err, data) {
                    var fakeData = {
                        id: 0,
                        value: null,
                        status: RPC.Status.NotFound
            ...
            it('if args.id === 2, error', function (done) {
                var devEnableStub = sinon.stub(zDev2, 'write', function (attrName, val, callback) {
                    process.nextTick(function () {
                        callback(new Error('Write fail'));
                    });
                });

                rpcApis.devWrite({ id: 2, attrName: 'manufacturer', value: 'abcdef' }, function (err, data) {
                    var fakeData = {
                        id: 2,
                        value: null,
                        status: RPC.Status.InternalServerError
                    ...
                    if (err.message === 'Write fail' && _.isEqual(data, fakeData)) {
                        devEnableStub.restore();
                        done();
                    }
                });
        ...
        describe('#.devIdentify', function() {
            it('if args.id === 0, no_such_device', function (done) {
                rpcApis.devIdentify({ id: 0 }, function (err, data) {
                    var fakeData = {
                        id: 0,
                        status: RPC.Status.NotFound
                    };
            ...
            it('if args.id === 2, error', function (done) {
                var devIdentifyStub = sinon.stub(zDev2, 'identify', function (callback) {
                    process.nextTick(function () {
                        callback(new Error('Identify fail'));
                    });
                });

                rpcApis.devIdentify({ id: 2 }, function (err, data) {
                    var fakeData = {
                        id: 2,
                        status: RPC.Status.InternalServerError
                    };

                    if (err.message === 'Identify fail' && _.isEqual(data, fakeData)) {
                        devIdentifyStub.restore();
                        done();
                    }
                });
            });
        ...
        describe('#.devPing', function() {
            it('if args.id === 0, no_such_device', function (done) {
                rpcApis.devPing({ id: 0 }, function (err, data) {
                    var fakeData = {
                        id: 0,
                        time: null,
                        status: RPC.Status.NotFound
            ...
            it('if args.id === 2, error', function (done) {
                var devPingStub = sinon.stub(zDev2, 'ping', function (callback) {
                    process.nextTick(function () {
                        callback(new Error('Ping fail'));
                    });
                });

                rpcApis.devPing({ id: 2 }, function (err, data) {
                    var fakeData = {
                        id: 2,
                        time: null,
                        status: RPC.Status.InternalServerError
        ...
        describe('#.devRemove', function() {
            it('if args.id === 0, no_such_device', function (done) {
                rpcApis.devRemove({ id: 0 }, function (err, data) {
                    var fakeData = {
                        id: 0,
                        permAddr: null,
                        status: RPC.Status.NotFound
                    ...
                    if (err.message === 'device not found' && _.isEqual(data, fakeData))
                        done();
                });
            });

            it('if args.id === 2, no_such_netCore', function (done) {
                var devGetStub = sinon.stub(zDev2, 'get', function (name) {
                    return (name !== 'netcore') ? 2 : undefined;
                });

                rpcApis.devRemove({ id: 2 }, function (err, data) {
                    var fakeData = {
                        id: 2,
                        permAddr: null,
                        status: RPC.Status.NotFound
                    ...
                    if (err.message === 'netcore not found' && _.isEqual(data, fakeData)) {
                        devGetStub.restore();
                        done();
                    }
                });
            ...
            it('if args.id === 2, error', function (done) {
                var ncRemoveStub = sinon.stub(zCore, 'remove', function (permAddr, callback) {
                    process.nextTick(function () {
                        callback(new Error('Remove fail'));
                    });
                });
            ...
            it('if args.id === 1', function (done) {
                ...
                rpcApis.devRemove({ id: 1 }, function (err, data) {
                    var fakeData = {
                        id: 1,
                        permAddr: '0x1234567890',
                        status: RPC.Status.Deleted
        ...
        describe('#.devGetProps', function() {
            it('if args.id === 0, no_such_device', function (done) {
                rpcApis.devGetProps({ id: 0 }, function (err, data) {
                    var fakeData = {
                        id: 0,
                        props: null,
                        status: RPC.Status.NotFound
            ...
            it('if args.id === 2', function (done) {
                var devGetStub = sinon.stub(zDev2, 'get', function (name, arg) {
                    return (name !== 'props') ? 2 : { name: 'mylight', location: 'bedroom'};
                });

                rpcApis.devGetProps({ id: 2, propNames: [ 'name', 'location' ] }, function (err, data) {
                    var fakeData = {
                        id: 2,
                        props: { name: 'mylight', location: 'bedroom'},
                        status: RPC.Status.Content
                    };
        ...
        describe('#.devSetProps', function() {
            it('if args.id === 0, no_such_device', function (done) {
                rpcApis.devSetProps({ id: 0, props: { description: 'for my baby' } }, function (err, data) {
                    var fakeData = {
                        id: 0,
                        status: RPC.Status.NotFound
                    };
            ...
            it('if args.id === 2', function (done) {
                var devSetStub = sinon.stub(zDev2, 'set', function (name, value) {
                    return;
                });

                rpcApis.devSetProps({ id: 2, props: { description: 'for my baby' } }, function (err, data) {
                    var fakeData = {
                        id: 2,
                        status: RPC.Status.Changed
                    };
    ...
    describe('Gadget', function() {
        describe('#.gadEnable', function() {
            it('if args.id === 0, no_such_device', function (done) {
                rpcApis.gadEnable({ id: 0 }, function (err, data) {
                    var fakeData = {
                        id: 0,
                        enabled: null,
                        status: RPC.Status.NotFound
            ...
            it('if args.id === 1', function (done) {
                rpcApis.gadEnable({ id: 1 }, function (err, data) {
                    var fakeData = {
                        id: 1,
                        enabled: true,
                        status: RPC.Status.Ok
            ...
            it('if args.id === 3, throw Error', function (done) {
                var gadEnableStub = sinon.stub(zGad2, 'enable', function () {
                    throw new Error('catchError');
                });

                rpcApis.gadEnable({ id: 3 }, function (err, data) {
                    var fakeData = {
                        id: 3,
                        enabled: null,
                        status: RPC.Status.InternalServerError
        ...
        describe('#.gadDisable', function() {
            it('if args.id === 0, no_such_device', function (done) {
                rpcApis.gadDisable({ id: 0 }, function (err, data) {
                    var fakeData = {
                        id: 0,
                        enabled: null,
                        status: RPC.Status.NotFound
            ...
            it('if args.id === 1', function (done) {
                rpcApis.gadDisable({ id: 1 }, function (err, data) {
                    var fakeData = {
                        id: 1,
                        enabled: false,
                        status: RPC.Status.Ok
            ...
            it('if args.id === 3, throw Error', function (done) {
                var gadDisableStub = sinon.stub(zGad2, 'disable', function () {
                    throw new Error('catchError');
                });

                rpcApis.gadDisable({ id: 3 }, function (err, data) {
                    var fakeData = {
                        id: 3,
                        enabled: null,
                        status: RPC.Status.InternalServerError
        ...
        describe('#.gadRead', function() {
            it('if args.id === 0, no_such_device', function (done) {
                rpcApis.gadRead({ id: 0, attrName: 'manufacturer'}, function (err, data) {
                    var fakeData = {
                        id: 0,
                        value: null,
                        status: RPC.Status.NotFound
            ...
            it('if args.id === 1, error', function (done) {
                var gadReadStub = sinon.stub(zGad1, 'read', function (attrName, callback) {
                    process.nextTick(function () {
                        callback(new Error('Read fail'));
                    });
                });

                rpcApis.gadRead({ id: 1, attrName: 'onOff'}, function (err, data) {
                    var fakeData = {
                        id: 1,
                        value: null,
                        status: RPC.Status.InternalServerError
        ...
        describe('#.gadWrite', function() {
            it('if args.id === 0, no_such_device', function (done) {
                rpcApis.gadWrite({ id: 0, attrName: 'onOff', value: 1 }, function (err, data) {
                    var fakeData = {
                        id: 0,
                        value: null,
                        status: RPC.Status.NotFound
            ...
            it('if args.id === 1, error', function (done) {
                var gadWriteStub = sinon.stub(zGad1, 'write', function (attrName, val, callback) {
                    process.nextTick(function () {
                        callback(new Error('Write fail'));
                    });
                });

                rpcApis.gadWrite({ id: 1, attrName: 'onOff', value: 1 }, function (err, data) {
                    var fakeData = {
                        id: 1,
                        value: null,
                        status: RPC.Status.InternalServerError
        ...
        describe('#.gadExec', function() {
            it('if args.id === 0, no_such_device', function (done) {
                rpcApis.gadExec({ id: 0, attrName: 'onOff' }, function (err, data) {
                    var fakeData = {
                        id: 0,
                        result: null,
                        status: RPC.Status.NotFound
            ...
            it('if args.id === 1, error', function (done) {
                var gadExecStub = sinon.stub(zGad1, 'exec', function (attrName, args, callback) {
                    process.nextTick(function () {
                        callback(new Error('Exec fail'));
                    });
                });

                rpcApis.gadExec({ id: 1, attrName: 'onOff', params: [] }, function (err, data) {
                    var fakeData = {
                        id: 1,
                        result: null,
                        status: RPC.Status.InternalServerError
                    ...
                    if (err.message === 'Exec fail' && _.isEqual(data, fakeData)) {
                        gadExecStub.restore();
                        done();
                    }
                });
        ...
        describe('#.gadWriteReportCfg', function() {
            it('if args.id === 0, no_such_device', function (done) {
                rpcApis.gadWriteReportCfg({ id: 0, attrName: 'onOff', rptCfg: { pmin: 10, pmax: 60 } }, function (err, data) {
                    var fakeData = {
                        id: 0,
                        result: null,
                        status: RPC.Status.NotFound
            ...
            it('if args.id === 1, error', function (done) {
                var gadWriteReportCfgStub = sinon.stub(zGad1, 'writeReportCfg', function (attrName, cfg, callback) {
                    process.nextTick(function () {
                        callback(new Error('Exec fail'));
                    });
                });

                rpcApis.gadWriteReportCfg({ id: 1, attrName: 'onOff', rptCfg: { pmin: 10, pmax: 60 } }, function (err, data) {
                    var fakeData = {
                        id: 1,
                        result: null,
                        status: RPC.Status.InternalServerError
        ...
        describe('#.gadReadReportCfg', function() {
            it('if args.id === 0, no_such_device', function (done) {
                rpcApis.gadReadReportCfg({ id: 0, attrName: 'onOff' }, function (err, data) {
                    var fakeData = {
                        id: 0,
                        cfg: null,
                        status: RPC.Status.NotFound
            ...
            it('if args.id === 1, error', function (done) {
                var gadWriteReportCfgStub = sinon.stub(zGad1, 'readReportCfg', function (attrName, callback) {
                    process.nextTick(function () {
                        callback(new Error('Exec fail'));
                    });
                });

                rpcApis.gadReadReportCfg({ id: 1, attrName: 'onOff' }, function (err, data) {
                    var fakeData = {
                        id: 1,
                        cfg: null,
                        status: RPC.Status.InternalServerError
        ...
        describe('#.gadGetProps', function() {
            it('if args.id === 0, no_such_device', function (done) {
                rpcApis.gadGetProps({ id: 0 }, function (err, data) {
                    var fakeData = {
                        id: 0,
                        props: null,
                        status: RPC.Status.NotFound
            ...
            it('if args.id === 1', function (done) {
                var gadGetStub = sinon.stub(zGad1, 'get', function (name, arg) {
                    return (name !== 'props') ? 1 : { name: 'abc', description: '123'};
                });

                rpcApis.gadGetProps({ id: 1, propNames: [ 'name', 'description' ] }, function (err, data) {
                    var fakeData = {
                        id: 1,
                        props: { name: 'abc', description: '123'},
                        status: RPC.Status.Content
                    };
            ...
            it('if args.id === 1, throw Error', function (done) {
                var gadGetStub = sinon.stub(zGad1, 'get', function (name, arg) {
                    if (name !== 'props')
                        return 1;
                    else
        ...
        describe('#.gadSetProps', function() {
            it('if args.id === 0, no_such_device', function (done) {
                rpcApis.gadSetProps({ id: 0, props: { name: 'abc', description: '123' } }, function (err, data) {
                    var fakeData = {
                        id: 0,
                        status: RPC.Status.NotFound
                    };
            ...
            it('if args.id === 1', function (done) {
                var gadSetStub = sinon.stub(zGad1, 'set', function (name, value) {
                    return;
                });

                rpcApis.gadSetProps({ id: 1, props: { name: 'one', description: '777'} }, function (err, data) {
                    var fakeData = {
                        id: 1,
                        status: RPC.Status.Changed
                    };
